...
set(REGRESSIONTEST_BRANCH "release-2025")
...
set(REGRESSIONTEST_MD5SUM "bee79b13a6d7d66eaa6f0e2cd20dc009" CACHE INTERNAL "MD5 sum of the regressiontests tarball for this GROMACS version")
...
set(GMX_VERSION_STRING_OF_FORK "2025-HIP-ENABLEMENT" CACHE INTERNAL
...
if (GMX_VERSION_STRING_OF_FORK)
    ...
    set(GMX_MANUAL_DOI_INTERNAL "10.5281/zenodo.14846105") # Set correct doi string here
    set(GMX_SOURCE_DOI_INTERNAL "10.5281/zenodo.14846130") # Set correct doi string here
endif()

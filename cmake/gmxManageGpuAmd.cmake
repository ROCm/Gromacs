...
if( (GMX_GPU OR GMX_GPU_AUTO) AND GMX_DETECT_GPU_AVAILABLE)
    message(STATUS "xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxHIP is finding !")
    find_package(hcc QUIET CONFIG PATHS /opt/rocm)
    find_package(hip QUIET CONFIG PATHS /opt/rocm)

    if ( hip_FOUND ) 
         message(STATUS "xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxHIP found in gmxManageGPU !")
    endif()
endif()
...
macro(gmx_gpu_setup)
    ...
    option(GMX_ROCM_NB_SINGLE_COMPILATION_UNIT "Whether to compile the CUDA non-bonded module using a single compilation unit." OFF)

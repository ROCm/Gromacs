...
/*! \brief
 * A HIP kernel which packs non-contiguous overlap data in Y-dimension
 *
...
/*! \brief
 * A HIP kernel which adds/puts grid overlap data received from neighboring rank in Y-dim
 *
 * \param[in] gm_realGrid          local grid
...
/*! \brief
 * A HIP kernel which adds grid overlap data received from neighboring rank
 *
 * \param[in] gm_realGrid          local grid
 * \param[in] gm_transferGrid      overlapping region from neighboring rank
...
/*! \brief
 * Launches HIP kernel to pack non-contiguous overlap data in Y-dimension
 *
...
/*! \brief
 * Launches HIP kernel to reduce/unpack overlap data in Y-dimension
 *
 * \param[in]  pmeGpu              The PME GPU structure.
 * \param[in] overlapSize          overlap Size in y-overlap region
 * \param[in] yOffset              offset of y-overlap region
...
/*! \brief
 * Launches HIP kernel to reduce overlap data in X-dimension
 *
 * \param[in]  pmeGpu              The PME GPU structure.
 * \param[in] overlapSize          overlap Size in y-overlap region
 * \param[in] realGrid             local grid

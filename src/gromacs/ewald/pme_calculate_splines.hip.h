...
__device__ __forceinline__ void pme_gpu_stage_atom_data(const PmeGpuHipKernelParams kernelParams,
...
__device__ __forceinline__ void calculate_splines_useorder(const PmeGpuHipKernelParams kernelParams,
                                                  const int                    atomIndexOffset,
                                                  const float3                 atomX,
                                                  const float                  atomCharge,
                                                  float* __restrict__ sm_theta,

...
template __global__ void pme_solve_kernel<GridOrdering::YZX, true>(const PmeGpuHipKernelParams);
template __global__ void pme_solve_kernel<GridOrdering::YZX, false>(const PmeGpuHipKernelParams);
template __global__ void pme_solve_kernel<GridOrdering::XYZ, true>(const PmeGpuHipKernelParams);
template __global__ void pme_solve_kernel<GridOrdering::XYZ, false>(const PmeGpuHipKernelParams);

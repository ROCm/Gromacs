...
struct PmeGpuGridParams
{
    ...
    int localRealGridSizePadded[DIM]; /* Is major dimension of this ever used in kernels? */
    ...
    HIDE_FROM_OPENCL_COMPILER(DeviceBuffer<float>) d_fftRealGrid[NUMFEPSTATES];

...
static void closeIEntry(NbnxnPairlistGpu* nbl, int nsp_max_av, gmx_bool progBal, float nsp_tot_est, int thread, int nthread, int length_limit = INT_MAX)
{
                             ...
                             t_nrnb*                   nrnb)
{
    ...
    pairlistSet(iLocality).constructPairlists(gridSet, pairSearch->work(), nbat, exclusions,
                                              minimumIlistCountForGpuBalancing_,maximumIlistCountForGpuBalancing_, nrnb,

...
#include "nbnxm_buffer_ops_kernels.hip.h"
...
/** Force only **/
#include "nbnxm_cuda_kernels.hip.h"
/** Force & energy **/
...
/* Prune-only kernels */
#include "nbnxm_cuda_kernel_pruneonly.hip.h"
...
#    include "nbnxm_cuda_kernel_VF_prune.hip.cpp"
#    include "nbnxm_cuda_kernel_pruneonly.hip.cpp"
 ...
 */
void nbnxnInsertNonlocalGpuDependency(const gmx_nbnxn_hip_t* nb, const InteractionLocality interactionLocality)
{
...
void gpu_copy_xq_to_gpu(gmx_nbnxn_hip_t* nb, const nbnxn_atomdata_t* nbatom, const AtomLocality atomLocality)
{
 ...
 */
void gpu_launch_kernel(gmx_nbnxn_hip_t* nb, const gmx::StepWorkload& stepWork, const InteractionLocality iloc)
{
    cu_atomdata_t* adat   = nb->atdat;
...
void gpu_launch_kernel_pruneonly(gmx_nbnxn_hip_t* nb, const InteractionLocality iloc, const int numParts)
{
    cu_atomdata_t* adat   = nb->atdat;
    cu_nbparam_t*  nbp    = nb->nbparam;
    cu_plist_t*    plist  = nb->plist[iloc];
...
void gpu_launch_cpyback(gmx_nbnxn_hip_t*        nb,

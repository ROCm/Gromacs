...
static constexpr unsigned int c_clEnergySize = 64U;
static constexpr unsigned int c_clShiftSize = 16U;
...
struct NbnxmGpu
{
    ...
    hipEvent_t nonlocal_done = nullptr;
    ...
    hipEvent_t misc_ops_and_local_H2D_done = nullptr;
    /*! \} */

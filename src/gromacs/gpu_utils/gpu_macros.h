...
#    else
#        define HIP_FUNC_QUALIFIER NULL_FUNC_QUALIFIER
#        define HIP_FUNC_ARGUMENT NULL_FUNC_ARGUMENT
#        define HIP_FUNC_TERM NULL_FUNC_TERM
#        define HIP_FUNC_TERM_WITH_RETURN(arg) NULL_FUNC_TERM_WITH_RETURN(arg)
#    endif

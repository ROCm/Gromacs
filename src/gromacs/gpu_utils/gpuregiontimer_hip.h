...
public:
    GpuRegionTimerImpl()
    {
        ...
        CU_RET_ERR(hipEventCreateWithFlags(&eventStart_, eventFlags), "GPU timing creation failure");
        CU_RET_ERR(hipEventCreateWithFlags(&eventStop_, eventFlags), "GPU timing creation failure");
    }
    ~GpuRegionTimerImpl()
    {

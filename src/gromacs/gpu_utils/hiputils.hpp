 ...
 */
#ifndef GMX_GPU_UTILS_HIPUTILS_HPP
#define GMX_GPU_UTILS_HIPUTILS_HPP
...
// in hip_kernel_utils.hpp. They could all live in a separate class/struct file.

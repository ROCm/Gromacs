 ...
 */
static inline std::string getDeviceErrorString(const hipError_t deviceError)
{
    return formatString("HIP error #%d (%s): %s.", deviceError, hipGetErrorName(deviceError),
 ...
 */
static inline void checkDeviceError(const hipError_t deviceError, const std::string& errorMessage)
{

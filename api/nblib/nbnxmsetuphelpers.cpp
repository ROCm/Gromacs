                                                   ...
                                                   gmx::ArrayRef<const real> nonbondedParameters)
{
    ...
    auto pairlistSets = std::make_unique<PairlistSets>(pairlistParams, false, 0, SHRT_MAX);
                                                   ...
                                                   const gmx::DeviceStreamManager& deviceStreamManager)
{
    ...
    auto pairlistSets = std::make_unique<PairlistSets>(pairlistParams, false, iListCount, SHRT_MAX);
    auto pairSearch   = std::make_unique<PairSearch>(
